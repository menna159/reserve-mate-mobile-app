...
import { useNavigation } from '@react-navigation/native'; // Assuming you are using React Navigation for routing
import styles from './AboutUsSection.module';
import { routes } from '../../../routes';
const AboutUsSection = () => {
  const navigation = useNavigation(); // For navigation when clicking the "Read More" button
